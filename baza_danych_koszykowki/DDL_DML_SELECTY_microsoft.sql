ALTER TABLE druzyna DROP CONSTRAINT druzyna_liga;

ALTER TABLE mecz DROP CONSTRAINT mecz_druzyna_1;

ALTER TABLE mecz DROP CONSTRAINT mecz_druzyna_2;

ALTER TABLE mecz DROP CONSTRAINT mecz_stadion;

ALTER TABLE sponsor_druzyna DROP CONSTRAINT sponsor_druzyna_druzyna;

ALTER TABLE sponsor_druzyna DROP CONSTRAINT sponsor_druzyna_sponsor;

ALTER TABLE transfer DROP CONSTRAINT transfer_druzyna_kupujaca;

ALTER TABLE transfer DROP CONSTRAINT transfer_druzyna_sprzedajaca;

ALTER TABLE transfer DROP CONSTRAINT transfer_zawodnik;

ALTER TABLE zawodnik DROP CONSTRAINT zawodnik_druzyna;

ALTER TABLE zawodnik DROP CONSTRAINT zawodnik_pozycja;
...
CREATE TABLE transfer (
    ...
    druzyna_sprzedajaca int  NOT NULL,
    druzyna_kupujaca int  NOT NULL,
    id_zawodnik int  NOT NULL,
    kwota_transferu money  NOT NULL,
    data date  NOT NULL,
...
INSERT INTO mecz (id_mecz, druzyna_1, druzyna_2, data_godzina, stadion) VALUES (1, 1, 2, '2023-06-15 18:00:00', 1);
INSERT INTO mecz (id_mecz, druzyna_1, druzyna_2, data_godzina, stadion) VALUES (2, 2, 3, '2023-06-16 20:30:00', 2);
INSERT INTO mecz (id_mecz, druzyna_1, druzyna_2, data_godzina, stadion) VALUES (3, 1, 3, '2023-06-17 16:15:00', 3);
...
--1. Zwraca imiona zawodników, którzy urodzili się po 1 stycznia 1984 roku
SELECT imie
FROM zawodnik
WHERE data_urodzenia > '1984-01-01';
...
--3. Zwraca nazwę i kraj ligi, których poziom wynosi 1
SELECT nazwa, kraj
FROM liga
WHERE poziom = 1;

--4. Zwraca wszystkie informacje o sponsorach, których branża zawiera w sobie "sportowe"
SELECT *
FROM sponsor
WHERE branza LIKE '%sportowe%';

--5. Zwraca drużynę sprzedającą i drużynę kupującą dla transferów, których kwota jest mniejsza od 4,5 mln lub większa od 5,5 mln
SELECT druzyna_sprzedajaca, druzyna_kupujaca, kwota_transferu
FROM transfer
WHERE kwota_transferu < 4500000 OR kwota_transferu > 5500000;

--6. Zwraca imiona i nazwiska zawodników, którzy grają na pozycji, która w swojej nazwie zawiera literę "o"
...
--8. Zwraca nazwę drużyny i nazwę sponsora pomiędzy którymi doszło do umowy, której wartość jest powyżej 600000
...
--9. Zwraca imię, nazwisko i numer zawodników, którzy odbyli transfer po 1 stycznia 2020 roku
SELECT zawodnik.imie, zawodnik.nazwisko, zawodnik.numer
FROM zawodnik
JOIN transfer ON zawodnik.id_zawodnik = transfer.id_zawodnik
WHERE transfer.data > '2020-01-01';
...
WHERE zawodnik.data_urodzenia < '1990-01-01'
...
--16. Zwraca nazwy sponsorów, którzy mają umowę przekraczającą średnią wartość wszystkich umów
SELECT nazwa
FROM sponsor
WHERE (
